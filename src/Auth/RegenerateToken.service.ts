import { UnprocessableEntityException, Injectable, HttpException, UnauthorizedException, HttpStatus } from '@nestjs/common';
import { JwtService, JwtSignOptions } from '@nestjs/jwt';
import { TokenExpiredError } from 'jsonwebtoken';
import { UserDocument, UserSchema } from 'src/User/user.model';
...
async setCurrentRefreshToken(refreshToken: string, userId: number) {
  ...
  return await this.userService.saveorupdateRefreshToken(userId as any,
